<template>
  <div class="table">
    ...
    <el-table size="mini" ref="multipleTable" border style="width:100%" height="680px" :data="data" @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="timeBucket" label="时段" align="center" width="120"></el-table-column>
...
<script>
import {getCasualByUserId, deleteCasual} from '../api/index';
